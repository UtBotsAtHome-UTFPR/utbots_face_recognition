...
class train_subprocess:
    ...
    def __init__(self, train_dir: str, model_save_dir: str):
        ...
        if not os.path.isdir(model_save_dir[:model_save_dir.rfind("/")]):
            os.mkdir(model_save_dir[:model_save_dir.rfind("/")])
...
if __name__ == "__main__":
    ...
    # Run with
    # python3 train_subprocess.py path/face_recognition_module/faces path/face_recognition_module/models/model.clf
